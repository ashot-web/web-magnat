...
@section('breadcrumb')
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add Work</h3>
        </div>
    </div>
@endsection
@section('content')
    <section class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form method="post" id="add-admin-form" action="{{ route('work.store') }} "
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label lable-right">TypeEN<span
                                            class="label-color">*</span></label>
                                <div class="col-md-6">
                                    <input type="text" name="type_en" class="form-control" value=""
                                           placeholder="TypeEN">
                                </div>
                            </div>
                            <div class="form-group">
