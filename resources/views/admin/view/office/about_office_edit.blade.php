        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form method="post" id="add-admin-form" action="{{ route('about_office.update',['id'=>$about_offices->id]) }} "
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="title_hy" class="form-control"
                                           value="{{$about_offices->title_hy}}" placeholder="TitleHY">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="title_ru" class="form-control"
                                           value="{{$about_offices->title_ru}}" placeholder="TitleRU">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label lable-right">TitleEN<span
                                            class="label-color">*</span></label>
                                <div class="col-md-6">
                                    <input type="text" name="title_en" class="form-control" value="{{$about_offices->title_en}}"
                                           placeholder="TitleEN">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label lable-right">AboutHY<span
                                            class="label-color">*</span></label>
                                <div class="col-md-6">
                                    <textarea type="text" name="about_hy" class="form-control ck_editor" placeholder="AboutHY">{{$about_offices->about_hy}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea type="text" name="about_ru" class="form-control ck_editor"
                                              placeholder="AboutRU"> {{$about_offices->about_ru}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea type="text" name="about_en" class="form-control ck_editor"
                                              placeholder="AboutEN">{{$about_offices->about_en}}</textarea>
                                </div>
                            </div>
                        </div>
