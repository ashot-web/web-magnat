            ...
            <div class="row breadcrumbs-top">
                ...
                <div class="float-right breadcrumb-wrapper col-2">
                    <ol class=" float-right breadcrumb">
                        <li class="float-right breadcrumb-item"><button class="btn btn-primary" style="padding: 5px 10px"><a style="color: unset" href="{{route('office.create')}}"><i class="la la-plus"></i></a> </button></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <table class="table">
                    ...
                    @foreach($offices as $office)
                        <tr>
                            ...
                            <td>{{$office->name_hy}}</td>
                            <td>{{$office->name_ru}}</td>
                            <td>{{$office->name_en}}</td>
                            <td>{{$office->photo}}</td>
                            <td>
                                <a href="{{route('office.edit', ['id' => $office->id])}}"><i class="la la-edit"></i></a>
