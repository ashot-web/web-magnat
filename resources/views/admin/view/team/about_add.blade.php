...
@section('breadcrumb')
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            ...
            <h3 class="content-header-title">Add About Team</h3>
        </div>
    </div>
@endsection
@section('content')
    <section class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form method="post" id="add-admin-form" action="{{ route('about_team.store') }} "
                                ...
                                <div class="col-md-6">
                                    <select name="worker_id" class="form-control">
                                        @foreach($workers as $worker)
                                            <option value="{{$worker->id}}">{{$worker->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
